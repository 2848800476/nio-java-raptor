...
public interface ProtocolHandler {
	public void onOneThreadSessionOpen(SyncBuffPool buffPool,Protocol protocol,IoSession session,ProtecolHandlerAttachment attachment);
	...
	public void onOneThreadMessageRecieved(SyncBuffPool buffPool,Protocol protocol,
			IoSession session, Object receiveObject,ProtecolHandlerAttachment attachment);

	public void onOneThreadMessageSent(SyncBuffPool buffPool,Protocol protocol,
			IoSession session,ProtecolHandlerAttachment attachment);
}
