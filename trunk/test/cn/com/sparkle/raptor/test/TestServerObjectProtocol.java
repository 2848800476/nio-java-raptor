...
public class TestServerObjectProtocol {
	...
	public static void main(String[] args) throws IOException, QueueFullException {
		...
		nsc.setCycleRecieveBuffCellSize(3000);
...
//		nsc.setSentBuffSize( 8 * 1024);
		...
		server.bind(new InetSocketAddress(1234),new MultiThreadProtecolHandler(5000, 4 * nsc.getSentBuffSize(), 20, 300, 60, TimeUnit.SECONDS,new ObjectProtocol(), new TestObjectProtocolHandler()));
