...
public class TestServerByteProtocol {
	...
	public static void main(String[] args) throws Exception {
		...
		nsc.setCycleRecieveBuffCellSize(6000);
...
//		nsc.setRecieveBuffSize(32* 1024);
		...
		server.bind(new InetSocketAddress(1234),new MultiThreadProtecolHandler(5000, 16 * 1024, 2, 300, 60, TimeUnit.SECONDS,new ByteProtocol(1024), new TestByteProtocolHandler()));
